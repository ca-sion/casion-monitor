                    ...
                    <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-md transition-all duration-300 hover:shadow-lg">
                        <div class="mb-4 flex items-start justify-between">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                @endif
                                <a href="{{ route('athletes.injuries.recovery-protocols.edit', ['hash' => $athlete->hash, 'injury' => $injury->id, 'recoveryProtocol' => $protocol->id]) }}" class="text-gray-400 hover:text-gray-600">
                                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"/><path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd"/></svg>
                                </a>
                            </div>
                        </div>
