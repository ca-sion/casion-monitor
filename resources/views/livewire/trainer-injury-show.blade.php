    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div class="space-y-8 lg:col-span-2">
            <flux:card class="p-0">
                <div class="border-b border-gray-200 p-4">
                    <div class="flex items-center">
                        <flux:icon class="text-primary-500 mr-2 h-6 w-6" name="information-circle"></flux:icon>
            ...
            <flux:card class="p-0">
                <div class="border-b border-gray-200 p-4">
                    <div class="flex items-center">
                        <flux:icon class="text-primary-500 mr-2 h-6 w-6" name="chat-bubble-left-right"></flux:icon>
                    ...
                    <div class="p-6">
                        @if ($injury->healthEvents->isEmpty())
                            <div class="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50/50 py-10 text-center">
                                <flux:icon class="mx-auto h-12 w-12 text-gray-400" name="document-magnifying-glass"></flux:icon>
                                    ...
                                    <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-all duration-300 hover:shadow-md">
                                        <div class="mb-2">
                                            <flux:link class="text-sm"
                                                :href="route('trainers.health-events.edit', ['hash' => $trainer->hash, 'healthEvent' => $healthEvent])">
