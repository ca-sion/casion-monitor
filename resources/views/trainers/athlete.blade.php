                ...
                @foreach ($athlete->injuries as $injury)
                    <div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
                        <div class="mb-4 flex items-start justify-between">
                            ...
                            <a class="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-3 py-2 text-sm font-medium leading-4 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" href="{{ route('trainers.injuries.health-events.create', ['hash' => $trainer->hash, 'injury' => $injury->id]) }}">
